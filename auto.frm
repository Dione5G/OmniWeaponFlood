...
If selec.Text = "F2" Then
blank.Text = ":push x"
ElseIf selec.Text = "F3" Then
blank.Text = ":pull x"
ElseIf selec.Text = "F4" Then
blank.Text = ":moonwalk"
ElseIf selec.Text = "F5" Then
blank.Text = ":sit"
ElseIf selec.Text = "F6" Then
blank.Text = Form1.Combo1.Text
End If
                         ElseIf IDENTIFIC.Caption = "OmniPush" Then
If selec.Text = "F3" Then
blank.Text = Logger.Text2.Text
ElseIf selec.Text = "F4" Then
blank.Text = ":moonwalk"
ElseIf selec.Text = "F5" Then
blank.Text = ":sit"
...
ElseIf selec.Text = "F7" Then
blank.Text = Npush.Text5.Text
ElseIf selec.Text = "F8" Then
blank.Text = Npush.Text6.Text
ElseIf selec.Text = "F9" Then
blank.Text = Npush.Text7.Text
ElseIf selec.Text = "F10" Then
